    ...
    <div className="pt-20 min-h-screen">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-10">
        <header className="mb-10">
          <h1 className="font-headline text-5xl font-extrabold tracking-tight mb-3">Community Forum</h1>
          <p className="text-on-surface-variant text-lg">A safe space to share, support, and connect. Be kind. Be you.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-10">
          ...
          <div className="space-y-6">
            {/* Guidelines */}
            <Card className="rounded-2xl border-calm/30 bg-calm/5">
              <CardContent className="p-4 flex items-start gap-3">
                <Shield className="h-5 w-5 text-calm mt-0.5 shrink-0" />
                <div className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Community Guidelines:</strong> This is a safe, judgment-free zone. Be respectful, supportive, and kind. If you or someone is in crisis, please visit our{" "}
                  <a href="/dashboard/emergency" className="text-destructive font-medium hover:underline">Emergency page</a>.
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl">
              <CardHeader className="pb-3">
                <CardTitle className="font-headline text-base">Share What's on Your Mind</CardTitle>
              </CardHeader>
            ...
            <div className="space-y-4">
              {posts.map((post) => (
                <Card key={post.id} className="rounded-2xl editorial-shadow">
                  <CardContent className="p-6">
                    ...
                    {post.title && (
                      <h3 className="text-xl font-headline font-bold mb-3 leading-tight">{post.title}</h3>
                    )}
                    <p className="text-muted-foreground leading-relaxed mb-5">{post.content}</p>
