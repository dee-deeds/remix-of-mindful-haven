...
export default function Counselors() {
  ...
  const [checkedLocations, setCheckedLocations] = useState<string[]>(["On-Campus"]);
  const { user } = useAuth();
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-6 md:px-12 py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            {/* Urgent Support Card */}
            <div className="md:col-span-2 xl:col-span-2 bg-inverse-surface rounded-xl p-8 flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1 text-center md:text-left">
                <span className="inline-block px-4 py-1 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-widest rounded-full mb-4">
                  Urgent Support
                </span>
                <h2 className="text-3xl font-headline font-bold text-inverse-on-surface mb-4 leading-tight">
                  Can't wait for an appointment?
                </h2>
                <p className="text-inverse-on-surface/60 text-sm mb-6 max-w-md">
                  Our crisis intervention team is available 24/7 for immediate tele-health consultations. No booking required for urgent needs.
                </p>
                <Link to="/emergency">
                  <Button variant="secondary" className="rounded-full bg-card text-foreground hover:bg-primary-fixed font-headline">
                    Speak to Someone Now
                  </Button>
                </Link>
              </div>
              <div className="w-full md:w-64 h-48 rounded-xl bg-foreground/10 backdrop-blur-md flex items-center justify-center">
          ...
          <div className="py-20 text-center">
            <p className="text-muted-foreground/40 font-medium italic">
              All professionals are verified by the University Wellness Board.
            </p>
          </div>
        </main>
      </div>
