      ...
      <div className="flex">
        ...
        <aside className="hidden lg:flex flex-col gap-6 py-10 h-screen w-72 rounded-r-xl sticky top-20 bg-surface-container-low editorial-shadow overflow-y-auto">
          ...
          <div className="mt-auto px-6 mb-8">
            <Button
              variant="secondary"
              className="w-full rounded-full bg-inverse-surface text-inverse-on-surface hover:opacity-90"
              onClick={() => setCheckedLocations([])}
            >
              Clear All Filters
            </Button>
          </div>
              ...
              >
                ...
                {user ? (
                  <Link to="/booking" className="mt-auto">
                    <Button className="w-full rounded-full font-headline gap-2">
                      <Calendar className="h-4 w-4" /> Book Appointment
                    </Button>
                  </Link>
                ) : (
                  <Link to="/login" className="mt-auto">
                    <Button variant="outline" className="w-full rounded-full font-headline">
                      Sign in to Book
                    </Button>
                  </Link>
                )}
